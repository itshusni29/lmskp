  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('manager.local_training_center')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.manager_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/manager/training_stages/local_training_center.blade.php ENDPATH**/ ?>