...
<?php $__env->startSection('content'); ?>
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">IC Training Assessments</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">INITIAL CONTROL Assessments</h6>
                    <p class="text-muted mb-3">Manage assessments for IC Training Stage:</p>
                        ...
                        <table id="dataTableExample" class="table table-striped">
                            ...
                            <?php $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('trainer.assessments.ic.create', $participant->id)); ?>" class="btn btn-primary btn-sm">Add</a>

                                        <!-- Check if the participant has an associated assessment -->
                                        <?php if($participant->icAssessment): ?>
                                            <a href="<?php echo e(route('trainer.assessments.ic.edit', $participant->icAssessment->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <?php else: ?>
...
<?php echo $__env->make('layout.trainer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/trainer/assessments/indexic.blade.php ENDPATH**/ ?>