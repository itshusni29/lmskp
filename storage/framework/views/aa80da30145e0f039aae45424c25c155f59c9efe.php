  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo e(route('trainingModules.create')); ?>" class="btn btn-primary mb-3">Create Module</a>
          ...
          <table id="dataTableExample" class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <!-- View Button -->
                  <a href="<?php echo e(route('trainingModules.show', $module->id)); ?>" class="btn btn-info btn-sm">View</a>

                  <!-- Edit Button -->
                  <a href="<?php echo e(route('trainingModules.edit', $module->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                  
                  <!-- Delete Button -->
                  <form action="<?php echo e(route('trainingModules.destroy', $module->id)); ?>" method="POST" class="d-inline" id="form-<?php echo e($module->id); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/admin/Module/index.blade.php ENDPATH**/ ?>