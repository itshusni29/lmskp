...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Create Assessment for <?php echo e($participant->name); ?></h6>

        <form action="<?php echo e(route('trainer.assessments.store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              ...
              <div class="form-group mb-4">
                  ...
                  <input type="text" class="form-control" value="<?php echo e($trainingStages->firstWhere('id', $trainingStage)->name); ?>" readonly>
                  <input type="hidden" name="training_stage_id" value="<?php echo e($trainingStage); ?>">
              </div>
...
<?php echo $__env->make('layout.trainer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/trainer/assessments/create.blade.php ENDPATH**/ ?>