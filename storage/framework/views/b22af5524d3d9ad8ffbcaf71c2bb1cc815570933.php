...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Edit Initial Control Assessment for <?php echo e($participant->name); ?></h6>

        <form action="<?php echo e(route('trainer.assessments.ic.update', $assessment->id)); ?>" method="POST">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.trainer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/trainer/assessments/editic.blade.php ENDPATH**/ ?>