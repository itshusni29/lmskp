  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?php echo e(route('post_tests.store')); ?>" method="POST" id="post-test-form">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-success" id="submit-btn">Create Post Test</button>
        </form>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/admin/postTest/create.blade.php ENDPATH**/ ?>