  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <!-- Filter DOJ Form -->
        <form method="GET" action="<?php echo e(route('admin.rekap.induction_training')); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/admin/rekap_training_stages/induction_training.blade.php ENDPATH**/ ?>