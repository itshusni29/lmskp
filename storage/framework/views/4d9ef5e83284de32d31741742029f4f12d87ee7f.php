  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('admin.spv.local_training_center')); ?>">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- Approval Form -->
        <form id="approvalForm" method="POST" action="<?php echo e(route('admin.spv.local_training_center.approve_post')); ?>">
          <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/spv/training_stages/local_training_center.blade.php ENDPATH**/ ?>