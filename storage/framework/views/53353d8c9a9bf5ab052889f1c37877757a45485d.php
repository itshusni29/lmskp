  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-muted mb-3">Manage and track participants for the Initial Control center below:</p>

        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('admin.spv.initial_control')); ?>">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- Approval Form -->
              <form id="approvalForm" method="POST" action="<?php echo e(route('admin.spv.initial_control.approve_post')); ?>">
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/spv/training_stages/initial_control.blade.php ENDPATH**/ ?>