  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo e(route('trainingClasses.create')); ?>" class="btn btn-primary mb-3">Add New Training Class</a>
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table table-striped">
            ...
            <tbody>
              <?php $__currentLoopData = $trainingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $trainingClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <a href="<?php echo e(route('trainingClasses.show', $trainingClass->id)); ?>" class="btn btn-info btn-sm">View</a>
                  <a href="<?php echo e(route('trainingClasses.edit', $trainingClass->id)); ?>" class="btn btn-warning btn-sm">Edit</a>

                  <!-- Delete Form -->
                  <form action="<?php echo e(route('trainingClasses.destroy', $trainingClass->id)); ?>" method="POST" id="form-<?php echo e($trainingClass->id); ?>" style="display:inline;">
                    <?php echo csrf_field(); ?>
      ...
      if (action === 'delete_training_class') {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            document.getElementById('form-' + id).submit(); // Submit the form if confirmed
          }
        });
      }
    }
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/admin/TrainingClass/index.blade.php ENDPATH**/ ?>