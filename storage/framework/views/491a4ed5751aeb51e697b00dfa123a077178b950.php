  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('admin.rekap.on_the_job_training')); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\lmsforkp\resources\views/pages/admin/rekap_training_stages/on_the_job_training.blade.php ENDPATH**/ ?>