$(function() {
  ...
  if($('#customersChart').length) {
    var options1 = {
      ...
      series: [{
        name: '',
        data: [48,50,50,63,48,50,68,50,60,57,33,100]
      }],
      xaxis: {
        type: 'datetime',
        categories: ["Jan 05 2024", "Feb 04 2024", "Mar 04 2024", "Apr 04 2024", "May 04 2024", "Jun 04 2024", "Jul 04 2024", "Aug 04 2024", "Sep 04 2024", "Oct 04 2024", "Nov 04 2024", "Dec 04 2024", ],
      },
      stroke: {
        width: 2,
        curve: "smooth"
  ...
  if($('#modulChart').length) {
    var options1 = {
      ...
      xaxis: {
        type: 'datetime',
        categories: ["Sep 04 2024", "Oct 04 2024", "Nov 04 2024", "Dec 04 2024",],
      },
      stroke: {
        width: 2,
        curve: "smooth"
    ...
    new ApexCharts(document.querySelector("#modulChart"),options1).render();
  }
  // New Modul Chart - END

// New Modul Chart
if($('#KelasChart').length) {
  var options1 = {
    chart: {
      type: "line",
      height: 60,
    ...
    xaxis: {
      type: 'datetime',
      categories: ["Sep 04 2024", "Oct 04 2024", "Nov 04 2024",],
    },
    stroke: {
      width: 2,
      curve: "smooth"
  ...
  new ApexCharts(document.querySelector("#KelasChart"),options1).render();
}
// New Modul Chart - END
  ...
  if($('#monthlySalesChart').length) {
    var options = {
      ...
      xaxis: {
        type: 'datetime',
        categories: ['01/02/2024','02/01/2024','03/01/2024','04/01/2024','05/01/2024','06/01/2024','07/01/2024', '08/01/2024','09/01/2024','10/01/2024', '11/01/2024', '12/01/2024'],
        axisBorder: {
          color: colors.gridBorder,
        },
        axisTicks: {
