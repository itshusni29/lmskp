...
class StudentPostTestController extends Controller
{
    ...
    public function index()
    {
        ...
        $postTests = PostTest::with(['results', 'trainingClass']) // pastikan relasi yang dibutuhkan dimuat
            ->get()
            ->map(function ($postTest) {
                // Ambil hasil percobaan pertama, kedua, atau ketiga
                $results = $postTest->results->sortByDesc('created_at'); // Urutkan berdasarkan tanggal percobaan
